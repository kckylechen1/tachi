...
<!-- OMX:RUNTIME:START -->
<session_context>
**Session:** omx-1775461790606-ipbhew | 2026-04-06T07:49:54.179Z

**Codebase Map:**
  apps/: eslint.config, App, AgentCanvas, HubDashboard, Inspector, Sidebar, main, api, vite.config
  crates/: accuracy_test, bench, bench_old, import_jsonl, index.d, migrate, migrate_db, real_data_test
  integrations/: benchmark_extraction, config.d, config, config, constants.d, constants, constants, index.d
  packages/: tachi, cli, start, status, stop, DaemonMenu, InitWizard, LogsView, MainMenu, McpAddForm
